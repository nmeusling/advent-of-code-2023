from src.day1.day1 import extract_digits, get_calibration_value, sum_all_calibration_values, \
    replace_first_and_last_written_numbers
...
def test_sum_all_calibration_values_with_replacement():
    text_values = ["two1nine", "eightwothree", "abcone2threexyz", "xtwone3four", "4nineeightseven2", "zoneight234",
                   "7pqrstsixteen"]
